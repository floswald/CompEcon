...
abstract: "The vast majority of modern-day economists need to deal with scientific computation in their daily work. Teaching *Scientific computing*  to yourself is possible, but doing so is inefficient (and not much fun). This course wants to teach you *Scientific computing* in an efficient (and fun #emoji.face) way. The unofficial title of this course is hence \"Scientific Computing: from Zero to Hero\""
format:
  typst:
    include-in-header:
      - text: |
...
editor: source
author: "Teacher: [Florian Oswald](https://floswald.github.io)"
---


## Course Overview

This is a course for PhD and Allievi students in Computational Economics. In general, you should expect a thorough introduction to what we will call *Scientific computing*. Scientific computing turns theoretical models into something you can simulate, test, and explore with a computer. Scientific computing is something you can learn yourself, but it's hard and inefficient. In this course I'll try and teach you exactly that. 

After a thorough introduction, you will learn about some commonly used methods in Computational Economics. These methods are being used in *all* fields of Economics, so we will not limit ourselves to any given subfield, but rather will we study techniques which are helpful in all of them. The course has a clear focus on applying what you learn. We will cover the theoretical concepts that underlie each topic, but you should expect a fair amount of *hands on* action required on your behalf. In the words of the great [Che-Lin Su](https://scholar.google.com/citations?user=6AZSMiwAAAAJ&hl=en):
...
You can see the current table of contents on the course website [here](https://floswald.github.io/CompEcon/#outline-of-topics). This is content is subject to be revised. In short, there will be additional material assuming very little or no programming knowledge. Main topics to be added:

1. How does your computer work?
2. How to organize/share/collaborate on code for scientific computing? Spoiler: *not dropbox*.
3. How to run a job on a super computer?
4. What is reproducibility, and what is a docker container?

## Prerequisites

1. You need a laptop. 
2. We will start with some material from [Introduction to Programming](https://floswald.github.io/ScPoProgramming).
...
1. Check out what is being taught in the [Introduction to Programming](https://floswald.github.io/ScPoProgramming) course and see whether you can spend some time on this yourself. It's suitable for self-study.
...
* [The JPE Dataverse](https://dataverse.harvard.edu/dataverse/JPE)
