...
- Windows: WSL2 or containers often needed
...
![Brian Fox](https://upload.wikimedia.org/wikipedia/commons/3/35/BrianJFox.png){width=60%}

![Richard Stallman](https://upload.wikimedia.org/wikipedia/commons/3/38/Richard_Stallman_Bologna_2024_abc1.jpg){width=60%}
...
# The Shell 💻 <br> (Open Your Terminals!) {background-color="#40666e"}
...
# Your Text Editor ⌨️ <br> {background-color="#40666e"}
...
5. Notepad++
6. TextEdit
7. many more... choose your location on the comfort vs bare metal scale
:::
::: 
...
::: {.fragment}
3. What is `20221121-appendixA.tex` vs `20221121-appendix-former-B.tex`?
:::
...
<!-- 
::: {.fragment}
How do professional developers deal with this problem? 🤔
...
* Dropbox works to simply sync files. But fails for:
  ...
  * Rolling back to exactly the state your code was in when you got that result 6 months agos
...
# Notebooks / Dynamic Reports 📝 {background-color="#40666e"}
