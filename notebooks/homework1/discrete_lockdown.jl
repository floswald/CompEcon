...
In this homework we want to make a small modification to the discrete SIR model introduced in [this notebook](https://floswald.github.io/julia-bootcamp/09-introsir.html).
...
# you need to copy the code for the `discrete_SIR` function from the linked notebook above 
...
md"
* Now Make a plot similar to the one in the lecture from that first model. (copy the code which defines `discrete_time_SIR_plot` in [this notebook](https://floswald.github.io/julia-bootcamp/09-introsir.html)!)
...
@bind 🔒start Slider(1:200,default = 50)

# ╔═╡ 68d2e158-5bc4-11eb-2a84-35548106ce43
@bind 🔒stop  Slider(1:200,default = 100)

# ╔═╡ d10fe5c2-5bc4-11eb-3f5f-fb8a8220cef4
@bind 🔒intensity  Slider(0.0:0.01:1.0,default = 0.5)
...
manifest_format = "2.0"
project_hash = "5e6f5412c9ebbde6cc86f5deeade42820837b078"
