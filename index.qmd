...
Section | Topic
------ | ------
1      | Why worry about computation in Economics?
2      | What is an OS?
3      | Does it matter how one writes code?
4      | Programming Languages - Weapon of Choice
5      | `julia` [crash course 1](https://floswald.github.io/julia-bootcamp/)
6      | `julia` [crash course 2](https://floswald.github.io/julia-bootcamp/)
7      | Optimization 1: Recap of theory, Automatic Differentiation, setting up an optimizer
8      | Optimization 2: Algorithms
9      | Optimization 3: Constraints
10     | Parallel Computing
11     | Data and Machine Learning
12     | Dynamic Programming 1: Basics
13     | Dynamic Programming 2: Aiyagari and Shimer+Smith Models
14     | Discrete and Continous Choice Problems
15     | Dynamic Discrete Choice Models
